        ...
        return (
            <div>
                <section id="oceanwiki" className="section wiki">
                    <h2 className="text-center oceanphoneTitle">深海探險去</h2>
                    <div className="phone">
                        <div  className="oceaninfo">
                            <p className="contents">
                            深海，一般指水深200公尺以下，那裡黑暗、低溫、缺氧、壓力大、食物貧瘠，卻是地球上最大的生態系。在台灣深海裡，東北海域有熱泉生態系；西南海域有冷泉生態系，想要一窺深海神祕面紗嗎，一起探險去!
                            </p>
                        </div>
                    </div>
                    <div className="web">
                    ...
                    <div className="section-content oceanWikiContent">
