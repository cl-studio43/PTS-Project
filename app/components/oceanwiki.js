...
export default class OceanWiki extends Component {
    ...
    render() {
        ...
        const cardVideo = [
        {
            "iframe":<iframe  title="title1" src="https://www.youtube.com/embed/aHNsuYHlMQM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>,
        ...
        {
            "iframe":<iframe  title="title2" src="https://www.youtube.com/embed/FMl7GEaYwAE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>, 
        ...
        {
            "iframe":<iframe  title="title3" src="https://www.youtube.com/embed/aHNsuYHlMQM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>, 
        ...
        {
            "iframe":<iframe  title="title4"src="https://www.youtube.com/embed/FMl7GEaYwAE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>, 
        ...
        {
            "iframe":<iframe  title="title5" src="https://www.youtube.com/embed/FMl7GEaYwAE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>, 
                        ...
                        <div className="slider phone">
                            <Slider {...settings}>
                                ...
                                <Card
                                    ...
                                    hoverable={true}
                                    style={{ width: 240 }}
                                    cover={<img alt="感受深海的壓力" src={first} />}
                                >
